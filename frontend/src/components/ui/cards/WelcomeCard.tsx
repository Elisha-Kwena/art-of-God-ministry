...
const WelcomeCard:React.FC<WelcomeProps> = ({label,banner,description}) =>{
    return(
        <>
        <div className="flex flex-col group gap-4 items-center p-4 rounded-md transition-all duration-300 ease-in-out hover:-translate-y-2 hover:shadow-[0_1px_2px_rgba(0,0,0,0.05),0_1px_3px_rgba(0,0,0,0.6)]">
